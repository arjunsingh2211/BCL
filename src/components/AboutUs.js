...
<div className="container">
    <div className="row justify-content-center g-4">
        <div className="col-lg-3 col-md-4 col-sm-6 text-center">
            <img src="/images/tech26.png" alt="Tech Experience" className='imgStyle' />
        ...
        <div className="col-lg-3 col-md-4 col-sm-6 ms-lg-4 text-center">
            <img src="/images/tech27.png" alt="High ROI" className='imgStyle' />
        ...
        <div className="col-lg-3 col-md-4 col-sm-6 ms-lg-4 text-center">
            <img src="/images/tech28.jpg" alt="Deliver Value" className='imgStyle' />
...
<div className="container">
                <div className="row justify-content-center g-4">
                    <div className="col-lg-3 col-md-4 col-sm-6 text-center">
                        <img src="/images/tech29.png" alt="Tech Experience" className='imgStyle' />
                    ...
                    <div className="col-lg-3 col-md-4 col-sm-6 ms-lg-4 text-center">
                        <img src="/images/tech30.png" alt="High ROI" className='imgStyle' />
                    ...
                    <div className="col-lg-3 col-md-4 col-sm-6 ms-lg-4 text-center">
                        <img src="/images/tech31.png" alt="Deliver Value" className='imgStyle' />
